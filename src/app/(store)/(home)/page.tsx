        ...
        return (
          ...
          >
            <Image
              ...
              alt="Imagem do produto"
            />
            <div className="absolute bottom-10 right-10 h-12 flex items-center gap-2 md:max-w-[220px] max-w-[280px] rounded-full border-2 border-zinc-500 bg-black/60 p-1 pl-5">
